...
bc..
require 'scorm_cloud'
sc = ScormCloud::ScormCloud.new(appkey,secret)
...
**Add the following to /config/initializers/scorm_cloud.rb.**

Don't forget to change MyApplication to the name of your application.

bc. MyApplication::Application.configure do |config|
	ScormCloud::ScormRailsHelpers.appkey = "my_app_key"
	ScormCloud::ScormRailsHelpers.appkey = "my_secret_key"
end

**Use the helpers to reduce code in your controllers**
...
bc. # app/views/course/index.html.erb
<ul>
<%= @courses.each |course| %>
	<li>
